 ...
 *
 ***
 * 20170615 SHSU: Handling of blend mode during SVG Export and Import caused 
 * portion of scratchwork cleared using the Eraser to appear as white opaque.
 * It was identified that, during export, blend mode was exported as inline
 * CSS style, as opposed to SVG element attribute, which was done in prior versions.  
 * During import, inline CSS styled blend mode does not seem to be handled correctly,
 * and behavior looked to be importing as normal as opposed to destination-out.
 * Code change at line 13285 revert blend mode handling to SVG element attribute method.
 * (Search for tag SVG_IMPORT_EXPORT_BLEND_MODE_CHANGE)
 * Issue is being tracked here:  https://github.com/paperjs/paper.js/issues/1296
 */
...
var SvgStyles = Base.each({
    ...
    blendMode: ['mix-blend-mode', 'string']  // SVG_IMPORT_EXPORT_BLEND_MODE_CHANGE
}, function(entry, key) {
	var part = Base.capitalize(key),
		lookup = entry[2];
	this[key] = {
